...
@section('content')
    <div class="min-h-screen py-8 px-4 md:px-8">
        <!-- Back Button -->
        <div class="mb-6">
            <a href="{{ route('kaprodi.pengajuanPKL.index') }}" class="inline-flex items-center text-gray-700 hover:text-green-600 transition-colors">
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            <form action="{{ route('kaprodi.pengajuanPKL.store') }}" method="POST" class="space-y-8">
                @csrf
