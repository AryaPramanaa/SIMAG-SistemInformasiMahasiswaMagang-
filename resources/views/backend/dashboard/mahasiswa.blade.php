    ...
    <nav id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-white shadow-lg transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-40">
        ...
        <div class="flex flex-col justify-between h-[calc(100%-5rem)]">
            <ul class="px-4 py-6 space-y-2">
                ...
                <li>
                    <a href="{{ route('mahasiswa.lowonganPKL.index') }}" class="flex items-center gap-x-3 px-4 py-3 rounded-lg {{ request()->is('mahasiswa/lowonganPKL') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-100' }} transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg>
                ...
                <li>
                    <a href="{{ route('mahasiswa.pengajuanPKL.index') }}" class="flex items-center gap-x-3 px-4 py-3 rounded-lg {{ request()->is('mahasiswa/pengajuanPKL') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-100' }} transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="{{ route('mahasiswa.daftarPerusahaanPKL.index') }}" class="flex items-center gap-x-3 px-4 py-3 rounded-lg {{ request()->is('mahasiswa/daftarPerusahaanPKL') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-100' }} transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
