    ...
    <nav id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-white shadow-lg transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-40">
        ...
        <div class="flex flex-col justify-between h-[calc(100%-5rem)]">
            <ul class="px-4 py-6 space-y-2">
                ...
                <li>
                    <a href="{{ route('perusahaan.lowonganPKL.index') }}" class="flex items-center gap-x-3 px-4 py-3 rounded-lg {{ request()->is('perusahaan/lowonganPKL') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-100' }} transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="{{ route('perusahaan.laporanMahasiswa.index') }}" class="flex items-center gap-x-3 px-4 py-3 rounded-lg {{ request()->is('perusahaan/laporanMahasiswa*') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-100' }} transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="{{ route('perusahaan.pembimbingIndustri.index') }}" class="flex items-center gap-x-3 px-4 py-3 rounded-lg {{ request()->is('perusahaan/pembimbingIndustri*') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-100' }} transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Z" />
                        </svg>
                ...
                <li>
                    <a href="{{ route('perusahaan.profil.edit') }}" class="flex items-center gap-x-3 px-4 py-3 rounded-lg {{ request()->is('perusahaan/profil*') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-100' }} transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
