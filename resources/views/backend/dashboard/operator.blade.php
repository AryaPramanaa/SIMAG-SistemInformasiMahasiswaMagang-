...
<body class="bg-gray-100 font-['Poppins']">
    ...
    <!-- Sidebar -->
    <nav id="sidebar" class="w-[17%] top-0 left-0 min-h-screen bg-white shadow-lg transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-40 flex flex-col">
        <!-- Logo -->
        ...
        <div class="flex-1">
            <ul class="px-4 py-6 space-y-2">
                ...
                <li>
                    <a href="{{ route('operator.jadwalPendaftaran.index') }}" class="flex items-center gap-x-3 px-4 py-3 rounded-lg {{ request()->is('operator/jadwalPendaftaran') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-100' }} transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="" class="flex items-center gap-x-3 px-4 py-3 rounded-lg {{ request()->is('') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-100' }} transition-colors">
                        ...
                        <span>Surat Pelaksanaan PKL</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('operator.perusahaanPKL.index') }}" class="flex items-center gap-x-3 px-4 py-3 rounded-lg {{ request()->is('operator/perusahaanPKL*') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-100' }} transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="{{ route('operator.jurusanProdi.index') }}" class="flex items-center gap-x-3 px-4 py-3 rounded-lg {{ request()->is('operator/jurusanProdi') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-100' }} transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="{{ route('operator.akun.index') }}" class="flex items-center gap-x-3 px-4 py-3 rounded-lg {{ request()->is('operator/akun') ? 'bg-green-100 text-green-600' : 'hover:bg-gray-100' }} transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
