...
<body class="bg-gray-100 font-['Poppins']">
    ...
    <div class="flex min-h-screen">
        <!-- Sidebar -->
        <nav id="sidebar"
            class="w-[17%] top-0 left-0 min-h-screen bg-white shadow-lg transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-40 flex flex-col">
            <!-- Logo -->
        ...
        <!-- Main Content -->
        <main class="transition-all duration-300 w-[85%] min-h-screen">
            <div class="p-6">
