                            ...
                            <tr class="bg-white hover:bg-gray-50">
                                ...
                                <td class="px-6 py-5 whitespace-nowrap text-sm font-semibold text-center">
                                    <div class="flex items-center justify-center space-x-2">
                                        <a href="{{ route('operator.akun.show', $user->id) }}"
                                        ...
                                        <a href="{{ route('operator.akun.edit', $user->id) }}"
                                        ...
                                        <form action="{{ route('operator.akun.destroy', $user->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
