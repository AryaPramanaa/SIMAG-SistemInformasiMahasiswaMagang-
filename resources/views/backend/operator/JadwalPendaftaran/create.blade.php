    ...
    <div class="min-h-screen py-8 px-4 md:px-8">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <form action="{{ route('operator.jadwalPendaftaran.store') }}" method="POST">
                    @csrf
                    <div class="mb-6">
                    ...
                    <div class="flex justify-end space-x-4">
                        <a href="{{ route('operator.jadwalPendaftaran.index') }}"
                            class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                            Batal
                        </a>
                        <button type="submit"
