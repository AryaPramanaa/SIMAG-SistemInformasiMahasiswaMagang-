...
@section('content')
    <div class="min-h-screen py-8 px-4 md:px-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <form action="{{ route('mahasiswa.pembimbingIndustri.store') }}" method="POST" class="space-y-6">
                @csrf

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Nama Pembimbing -->
                    <div>
                        <label for="nama_pembimbing" class="block text-sm font-medium text-gray-700 mb-2">
                            Nama Pembimbing <span class="text-red-500">*</span>
                        </label>
                        <input type="text" name="nama_pembimbing" id="nama_pembimbing"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 @error('nama_pembimbing') border-red-500 @enderror"
                            value="{{ old('nama_pembimbing') }}" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="jabatan" id="jabatan"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 @error('jabatan') border-red-500 @enderror"
