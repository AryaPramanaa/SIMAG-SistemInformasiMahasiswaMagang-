    ...
    <div class="min-h-screen py-8 px-4 md:px-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900">{{ $pembimbingIndustri->perusahaan->bidang_usaha }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Alamat</label>
                            <p class="text-gray-900">{{ $pembimbingIndustri->perusahaan->alamat }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end mt-6 space-x-3">
                ...
                <form action="{{ route('mahasiswa.pembimbingIndustri.destroy', $pembimbingIndustri->id) }}" method="POST" class="inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit" onclick="return confirm('Apakah Anda yakin ingin menghapus pembimbing ini?')"
