            ...
            <form action="{{ route('mahasiswa.suratPernyataan.update', $suratPernyataan) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="jenis_surat" id="jenis_surat" value="{{ old('jenis_surat', $suratPernyataan->jenis_surat) }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Masukkan jenis surat">
                    </div>
