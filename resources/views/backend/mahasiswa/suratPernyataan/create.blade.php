...
@section('content')
    <div class="min-h-screen py-8 px-4 md:px-8">
        ...
        <div class="text-center mb-10">
            <h1 class="text-4xl font-bold text-gray-800 mb-3">Tambah Surat Pernyataan</h1>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <form action="{{ route('mahasiswa.suratPernyataan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Masukkan deskripsi surat pernyataan">{{ old('deskripsi') }}</textarea>
                    </div>
                </div>
