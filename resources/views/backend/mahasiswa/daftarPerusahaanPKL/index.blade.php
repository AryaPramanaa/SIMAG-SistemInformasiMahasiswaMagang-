    ...
    <div class="min-h-screen py-8 px-4 md:px-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-6">
            <div class="flex flex-wrap justify-between items-end gap-4">
                <form action="{{ route('mahasiswa.daftarPerusahaanPKL.index') }}" method="GET" class="flex flex-wrap gap-4 flex-1">
                ...
                <div class="w-full md:w-auto">
                    <a href="{{ route('mahasiswa.daftarPerusahaanPKL.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-150 inline-flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-5 whitespace-nowrap text-sm font-medium text-center">
                                    <div class="flex items-center justify-center space-x-3">
                                        ...
                                        <a href="{{ route('mahasiswa.daftarPerusahaanPKL.edit', $item->id) }}"
                                        ...
                                        <form action="{{ route('mahasiswa.daftarPerusahaanPKL.destroy', $item->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
