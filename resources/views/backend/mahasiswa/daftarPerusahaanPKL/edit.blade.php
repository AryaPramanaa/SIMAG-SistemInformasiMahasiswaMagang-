...
@section('content')
    <div class="min-h-screen py-8 px-4 md:px-8">
        <!-- Back Button -->
        <div class="mb-6">
            <a href="{{ route('mahasiswa.daftarPerusahaanPKL.index') }}" class="inline-flex items-center text-gray-700 hover:text-green-600 transition-colors">
            ...
            <form action="{{ route('mahasiswa.daftarPerusahaanPKL.update', $perusahaan->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <select name="status_kerjasama" id="status_kerjasama" 
                        class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500 @error('status_kerjasama') border-red-500 @enderror bg-gray-100"
                        disabled>
